<template>
  <div class="user-detail">
    <div class="title"><a-icon type="lock" />BẢO MẬT</div>
    <div>
      <div class="title-2">
        <h2>THAY ĐỔI MẬT KHẨU</h2>
        <p>
          Để bảo vệ tài khoản của bạn, bạn nên thường xuyên thay đổi mật khẩu
          bảo mật.
        </p>
      </div>
      <div class="detail-input">
        <h3>Mật khẩu cũ :</h3>
        <a-form-item
          :validate-status="oldPwdIndex.val"
          :help="oldPwdIndex.help"
        >
          <a-input
            name="oldPassword"
            @change="getPassword"
      ...
      <div class="detail-input">
        <h3>Mật khẩu mới :</h3>
        <a-form-item
          :validate-status="newPwdIndex.val"
          :help="newPwdIndex.help"
        >
          <a-input
            name="newPassword"
            @change="getPassword"
